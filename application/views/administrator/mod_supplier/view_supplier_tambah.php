    ...
    echo "<div class='col-md-12'>
          ...
          echo "<div class='col-md-12'>
                  ...
                  <tbody>
                    ...
                    <tr><th scope='row'>No Hp</th>   <td><input type='number' class='form-control' name='d'></td></tr>
                    <tr><th scope='row'>Alamat Email</th>   <td><input type='email' class='form-control' name='e'></td></tr>
                    <tr><th scope='row'>Kode Pos</th>   <td><input type='number' class='form-control' name='f'></td></tr>
                    <tr><th scope='row'>No Telpon</th>   <td><input type='number' class='form-control' name='g'></td></tr>
                    <tr><th scope='row'>Fax</th>   <td><input type='number' class='form-control' name='h'></td></tr>
